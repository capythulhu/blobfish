...
export default {
    ...
    options: {
        ...
        'no-comment': {
            alias: 'nc',
            describe: 'Do not add a comment to the top of generated files',
            type: 'boolean',
        }
    },
    handler: async (argv) => {
        ...
        for (const repository of blobfish) {
            for (const file of repository.files) {
                ...
                try {
                    ...
                    // Check if no-comment is passed as an argument
                    const noComment = argv['no-comment'] || argv.nc || false;

                    const comment = noComment ? '' : `// 🐡 THIS FILE IS AUTOGENERATED, please do not edit manually. 🐡
